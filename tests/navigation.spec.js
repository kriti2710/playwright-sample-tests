...
test.describe('Navigation', () => {
  ...
  test.describe('Navbar Navigation', () => {
    ...
    test.describe('Verify Navbar Links', () => {
      ...
      test('Verify that all the navbar links work correctly @firefox @smoke', async () => {
  ...
  test.describe('Contact Us Page', () => {
    ...
    test.describe('Submit Contact Us Form', () => {
      ...
      test('Verify that user can submit Contact Us form successfully @firefox @regression', async () => {
        await login();
