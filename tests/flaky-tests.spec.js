...
test.describe('Flaky Test Suite', { tag: '@chromium' }, () => {
  ...
  test('Flaky: race condition on link click', {
    annotation: [
  ...
  test('Flaky: network instability simulation', {
    annotation: [
      { type: 'testdino:priority', description: 'p2' },
      { type: 'testdino:feature', description: 'Flaky Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
  ...
  test('Flaky: element visibility race', {
    annotation: [
      { type: 'testdino:priority', description: 'p2' },
      { type: 'testdino:feature', description: 'Flaky Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
  ...
  test('Flaky: async operation timing', {
    annotation: [
      { type: 'testdino:priority', description: 'p2' },
      { type: 'testdino:feature', description: 'Flaky Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
  ...
  test('Flaky: animation transition timing', {
    annotation: [
      { type: 'testdino:priority', description: 'p2' },
      { type: 'testdino:feature', description: 'Flaky Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
  ...
  test('Flaky: state-dependent behavior', {
    annotation: [
      { type: 'testdino:priority', description: 'p2' },
      { type: 'testdino:feature', description: 'Flaky Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
  ...
  test('Flaky: resource loading race', {
    annotation: [
      { type: 'testdino:priority', description: 'p2' },
      { type: 'testdino:feature', description: 'Flaky Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
  ...
  test('Flaky: scroll position race', {
    annotation: [
      { type: 'testdino:priority', description: 'p2' },
      { type: 'testdino:feature', description: 'Flaky Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
  ...
  test('Flaky: localStorage race condition', {
    annotation: [
      { type: 'testdino:priority', description: 'p2' },
      { type: 'testdino:feature', description: 'Flaky Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
  ...
  test('Flaky: concurrent user actions', {
    annotation: [
      { type: 'testdino:priority', description: 'p2' },
      { type: 'testdino:feature', description: 'Flaky Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
