...
test.describe('Passed Test Suite', { tag: '@chromium' }, () => {
  ...
  test('Passed: homepage loads successfully', {
    annotation: [
  ...
  test('Passed: page title is present', {
    annotation: [
  ...
  test('Passed: example.com returns 200', {
    annotation: [
  ...
  test('Passed: example.com title matches', {
    annotation: [
      { type: 'testdino:priority', description: 'p2' },
      { type: 'testdino:feature', description: 'Passed Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
  ...
  test('Passed: body element is visible', {
    annotation: [
      { type: 'testdino:priority', description: 'p2' },
      { type: 'testdino:feature', description: 'Passed Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
  ...
  test('Passed: arithmetic assertion', {
    annotation: [
      { type: 'testdino:priority', description: 'p3' },
      { type: 'testdino:feature', description: 'Passed Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
      { type: 'testdino:context', description: 'Pure logic assertion with no browser dependency' },
    ],
  }, async () => {
    expect(2 + 2).toBe(4);
  });

  test('Passed: string contains check', {
    annotation: [
      { type: 'testdino:priority', description: 'p3' },
      { type: 'testdino:feature', description: 'Passed Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
  ...
  test('Passed: array length check', {
    annotation: [
      { type: 'testdino:priority', description: 'p3' },
      { type: 'testdino:feature', description: 'Passed Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
  ...
  test('Passed: playwright.dev loads', {
    annotation: [
      { type: 'testdino:priority', description: 'p2' },
      { type: 'testdino:feature', description: 'Passed Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
  ...
  test('Passed: navigation link exists', {
    annotation: [
      { type: 'testdino:priority', description: 'p2' },
      { type: 'testdino:feature', description: 'Passed Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
      { type: 'testdino:context', description: 'Verifies nav element is present on Playwright docs' },
    ],
  }, async ({ page }) => {
    await page.goto('https://playwright.dev/');
