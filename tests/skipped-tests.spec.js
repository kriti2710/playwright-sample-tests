...
test.describe('Skipped Test Suite', { tag: '@chromium' }, () => {
  ...
  test.skip('Skipped: social login with Google', {
    annotation: [
  ...
  test.skip('Skipped: Apple Pay checkout', {
    annotation: [
      { type: 'testdino:priority', description: 'p2' },
      { type: 'testdino:feature', description: 'Skipped Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
  ...
  test.skip('Skipped: multi-currency price display', {
    annotation: [
  ...
  test.skip('Skipped: guest order tracking', {
    annotation: [
      { type: 'testdino:priority', description: 'p2' },
      { type: 'testdino:feature', description: 'Skipped Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
  ...
  test.skip('Skipped: product comparison tool', {
    annotation: [
      { type: 'testdino:priority', description: 'p3' },
      { type: 'testdino:feature', description: 'Skipped Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
  ...
  test.skip('Skipped: bulk cart import via CSV', {
    annotation: [
      { type: 'testdino:priority', description: 'p3' },
      { type: 'testdino:feature', description: 'Skipped Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
  ...
  test.skip('Skipped: two-factor authentication setup', {
    annotation: [
  ...
  test.skip('Skipped: subscription renewal reminder', {
    annotation: [
      { type: 'testdino:priority', description: 'p2' },
      { type: 'testdino:feature', description: 'Skipped Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
  ...
  test.skip('Skipped: inventory low-stock alert', {
    annotation: [
      { type: 'testdino:priority', description: 'p2' },
      { type: 'testdino:feature', description: 'Skipped Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
  ...
  test.skip('Skipped: dark mode persistence across sessions', {
    annotation: [
      { type: 'testdino:priority', description: 'p3' },
      { type: 'testdino:feature', description: 'Skipped Demos' },
      { type: 'testdino:owner', description: 'qa-team' },
